...
const ZH = {
  ...
  'float.menuCollapseTitle': '收起控件（透明度 / 拆分 / 退出浮窗都在那条上）',
  'float.menuExpandTitle': '展开控件：透明度 / 拆成小窗 / 退出浮窗（快捷键 Ctrl+Alt+G）',
...
const EN: Dict = {
  ...
  'float.menuCollapseTitle': 'Hide controls (opacity / split / exit are on that bar)',
  'float.menuExpandTitle': 'Show controls: opacity / split into tiles / exit overlay (Ctrl+Alt+G)',
